...
function FilterDropDown() {
  ...
  return (
    <div className="mt-5 w-64 bg-white flex-col justify-center items-center">
      {/* Filter Header */}
      ...
      <div className="mb-6 pb-2 border-b-2 border-[#62C3C64D]">
        ...
        <div className="flex flex-col space-y-2">
          <input
            ...
            className="w-full h-2 bg-[#62C3C6] rounded-lg appearance-none"
          />
        </div>
      ...
      {/* Genetik (Genetics) */}
      <div className="mb-6 pb-2 border-b-2 border-[#62C3C64D]">
        <label className="block text-center text-[#365758] mb-2 font-semibold">Genetik</label>
      ...
      <div className="mb-6 pb-2 border-b-2 border-[#62C3C64D]">
        <label className="block text-center text-[#365758] mb-2 font-semibold">Bestrahltung</label>
        <div className="flex space-x-2 text-sm text-[#045A5C]">
          <button className="px-4 py-1 rounded  bg-[#62C3C6] ">bestrahlt</button>
          <button className="px-4 py-1 rounded bg-[#62C3C64D] ">nicht bestrahlt</button>
        </div>
      </div>
      ...
      <div className="mb-6 pb-2 border-b-2 border-[#62C3C64D]">
        ...
        <label className="block text-center text-[#365758] mb-2 font-semibold">Terpene</label>
